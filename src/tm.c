	  ...
	  if (salir == 0) {
		...
		break;
 	      ...
 	      case NEW_ORDER: /******************TRANSACCIÓN NEW_ORDER************************/
			...
			trans_new_order(&men.tran.new_order, clientela[men.id].shm);
	      ...
	      case PAYMENT: /*******TRANSACCIÓN PAYMENT******/
			...
			/********************** EJECUCIÓN DE TRANSACCIÓN *************************/
			trans_payment(&men.tran.payment, clientela[men.id].shm);
	      ...
	      case ORDER_STATUS:  /*******TRANSACCIÓN ORDER-STATUS******/
			...
			/********************** EJECUCIÓN DE TRANSACCIÓN *************************/
			trans_ostatus(&men.tran.ostatus, clientela[men.id].shm);
	      ...
	      case DELIVERY: /*******TRANSACCIÓN DELIVERY******/
			...
			/********************** EJECUCIÓN DE TRANSACCIÓN *************************/
			trans_delivery(&men.tran.delivery);
			...
			ftime(&sellohora);
			fprintf(f_tr_deli,"\n %d %d %d %d %d %d ",men.tran.delivery.w_id,men.tran.delivery.d_id,men.tran.delivery.seg,men.tran.delivery.mseg,sellohora.time,sellohora.millitm);
	      ...
	      case STOCK_LEVEL:/*se ha mandado una transaccion*/
			...
			/********************** EJECUCIÓN DE TRANSACCIÓN *************************/
			trans_stock_level(&men.tran.stock_level,clientela[men.id].shm);

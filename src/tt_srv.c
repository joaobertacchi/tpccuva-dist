...
#line 1 "/usr/include/postgresql/pgsql/sqlca.h"
...
#line 315 "bench_srv.c"
 int  w_id   ;
 
#line 316 "bench_srv.c"
 int  d_id   ;
 
#line 317 "bench_srv.c"
 double  d_ytd   ;
 
#line 318 "bench_srv.c"
 int  d_next_o_id   ;
 
#line 319 "bench_srv.c"
 int  no_o_id   ;
 
#line 320 "bench_srv.c"
 int  no_d_id   ;
 
#line 321 "bench_srv.c"
 int  no_w_id   ;
 
#line 322 "bench_srv.c"
 int  s_i_id   ;
 
#line 323 "bench_srv.c"
 int  s_quantity   ;
 
#line 324 "bench_srv.c"
 int  orden   ;
/* exec sql end declare section */
#line 325 "bench_srv.c"
...
/*Restoring d_next_o_id*/
	...
	fflush(stdout);
	orden=NEXT_O_ID;
	{ ECPGdo(__LINE__, 0, 1, NULL, "update district set d_next_o_id  =  ?  ", 
	ECPGt_int,&(orden),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 331 "bench_srv.c"
...
/*Restoring the new_order table */
	...
	{ ECPGdo(__LINE__, 0, 1, NULL, "delete from new_order ", ECPGt_EOIT, ECPGt_EORT);}
#line 345 "bench_srv.c"
	...
	for (i = 1; i <= num_alma; i++){/* for each district*/
		...
		for (z = N_OR_UNDELIVER; z <= NUM_ORDER; z++){ 
			...
			no_d_id=j;
			no_w_id=i;
			{ ECPGdo(__LINE__, 0, 1, NULL, "insert into new_order ( no_o_id  , no_d_id  , no_w_id  ) values (  ? ,  ? ,  ? )", 
	ECPGt_int,&(no_o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(no_d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(no_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 364 "bench_srv.c"
...
/*Restoring the orderr and order_line tables */
	...
	fflush(stdout);
	orden=NEXT_O_ID;
	{ ECPGdo(__LINE__, 0, 1, NULL, "delete from order_line where ol_o_id >=  ?", 
	ECPGt_int,&(orden),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 385 "bench_srv.c"
	...
	{ ECPGdo(__LINE__, 0, 1, NULL, "delete from orderr where o_id >=  ?", 
	ECPGt_int,&(orden),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 393 "bench_srv.c"
...
/*Restoring the stock table*/
	...
	for (w_id=1;w_id<=num_alma;w_id++){/*for each warehouse*/
		for(s_i_id=1;s_i_id<=NUM_ART;s_i_id++){/*for each item */
				...
				{ ECPGdo(__LINE__, 0, 1, NULL, "update stock set s_quantity  =  ? , s_ytd  = 0 , s_order_cnt  = 0 , s_remote_cnt  = 0  where s_w_id =  ? and s_i_id =  ?", 
	ECPGt_int,&(s_quantity),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(s_i_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 414 "bench_srv.c"
...
#line 438 "bench_srv.c"
 int  w_id   ;
 
#line 439 "bench_srv.c"
 double  w_ytd   ;
 
#line 440 "bench_srv.c"
 int  d_id   ;
 
#line 441 "bench_srv.c"
 double  d_ytd   ;
 
#line 442 "bench_srv.c"
 int  o_id   ;
 
#line 443 "bench_srv.c"
 char  c_data [ 501 ]   ;
 
#line 444 "bench_srv.c"
 int  c_id   ;
 
#line 445 "bench_srv.c"
 char  h_date [ 21 ]   ;
 
#line 446 "bench_srv.c"
 char  h_data [ 25 ]   ;
/* exec sql end declare section */
#line 447 "bench_srv.c"
...
/*Restoring the warehouse and district tables */
	...
	{ ECPGdo(__LINE__, 0, 1, NULL, "update warehouse set w_ytd  = 300000  ", ECPGt_EOIT, ECPGt_EORT);}
#line 455 "bench_srv.c"
	...
	fprintf(stdout,"OK.\n");
	fprintf(stdout,"	Restoring DISTRICT... ");
	{ ECPGdo(__LINE__, 0, 1, NULL, "update district set d_ytd  = 30000  ", ECPGt_EOIT, ECPGt_EORT);}
#line 463 "bench_srv.c"
...
/*Restoring customer and history tables*/
	...
	{ ECPGdo(__LINE__, 0, 1, NULL, "delete from history ", ECPGt_EOIT, ECPGt_EORT);}
#line 483 "bench_srv.c"
	...
	for(w_id=1;w_id<=num_alma;w_id++){ /*for each warehouse*/
		for(d_id=1;d_id<=10;d_id++){/*for each district*/
			for(c_id=1;c_id<=NUM_CLIENT;c_id++){/*for each customer*/
				...
				{ ECPGdo(__LINE__, 0, 1, NULL, "update customer set c_balance  = - 10 , c_ytd_payment  = 10 , c_payment_cnt  = 1 , c_data  =  ?  where c_w_id =  ? and c_d_id =  ? and c_id =  ?", 
	ECPGt_char,(c_data),(long)501,(long)1,(501)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 495 "bench_srv.c"
				...
				{ ECPGdo(__LINE__, 0, 1, NULL, "insert into history ( h_c_id  , h_c_d_id  , h_c_w_id  , h_d_id  , h_w_id  , h_date  , h_amount  , h_data  ) values (  ? ,  ? ,  ? ,  ? ,  ? ,  ? , 10 ,  ? )", 
	ECPGt_int,&(c_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	...
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(h_date),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(h_data),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 506 "bench_srv.c"
...
#line 532 "bench_srv.c"
 int  o_id   ;
/* exec sql end declare section */
#line 533 "bench_srv.c"


/* restoring the customer table */
	fprintf(stdout,"	Restoring CUSTOMER... ");
	{ ECPGdo(__LINE__, 0, 1, NULL, "update customer set c_delivery_cnt  = 0  ", ECPGt_EOIT, ECPGt_EORT);}
#line 537 "bench_srv.c"
...
/* restoring the orderr table */
	...
	o_id=N_OR_UNDELIVER;
	{ ECPGdo(__LINE__, 0, 1, NULL, "update orderr set o_carrier_id  = 0  where o_id >=  ? and o_id <= 3000", 
	ECPGt_int,&(o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 549 "bench_srv.c"
...
/* restoring order_line table */
	...
	{ ECPGdo(__LINE__, 0, 1, NULL, "update order_line set ol_delivery_d  = '1970-01-01'  where ol_o_id >=  ? and ol_o_id <= 3000", 
	ECPGt_int,&(o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 560 "bench_srv.c"
...
#line 592 "bench_srv.c"
 int  w   ;
/* exec sql end declare section */
#line 593 "bench_srv.c"


/* Conecting with the database */
{ ECPGconnect(__LINE__, 0, "tpcc" , NULL,NULL , NULL, 0); }
#line 596 "bench_srv.c"
/* USER USERNAME;*/

{ ECPGsetcommit(__LINE__, "on", NULL);}
#line 598 "bench_srv.c"


/* Obtaining the number of warehouses */
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from warehouse   ", ECPGt_EOIT, 
	ECPGt_int,&(w),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 601 "bench_srv.c"
...
/* doing vacuum */
{ ECPGdo(__LINE__, 0, 1, NULL, "vacuum    analyze ", ECPGt_EOIT, ECPGt_EORT);}
#line 615 "bench_srv.c"
...
#line 645 "bench_srv.c"
 int  w_id   ;
 
#line 646 "bench_srv.c"
 double  w_ytd   ;
 
#line 647 "bench_srv.c"
 double  d_ytd   ;
/* exec sql end declare section */
#line 648 "bench_srv.c"


	/* Checking the condition for each warehouse */
	for(w_id=1;w_id<=num_alm;w_id++){
		{ ECPGdo(__LINE__, 0, 1, NULL, "select  w_ytd  from warehouse where w_id =  ?  ", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
	ECPGt_double,&(w_ytd),(long)1,(long)1,sizeof(double), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 652 "bench_srv.c"

		/* Each district */
		{ ECPGdo(__LINE__, 0, 1, NULL, "select  SUM ( d_ytd )  from district where d_w_id =  ?  ", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
	ECPGt_double,&(d_ytd),(long)1,(long)1,sizeof(double), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 654 "bench_srv.c"
...
#line 679 "bench_srv.c"
 int  w_id   ;
 
#line 680 "bench_srv.c"
 int  d_id   ;
 
#line 681 "bench_srv.c"
 int  d_next_o_id   ;
 
#line 682 "bench_srv.c"
 int  o_id   ;
 
#line 683 "bench_srv.c"
 int  cuenta   ;
 
#line 684 "bench_srv.c"
 int  no_o_id   ;
/* exec sql end declare section */
#line 685 "bench_srv.c"
...
for(w_id=1;w_id<=num_alm;w_id++){
	...
	for(d_id=1;d_id<=10;d_id++){
		{ ECPGdo(__LINE__, 0, 1, NULL, "select  d_next_o_id  from district where d_w_id =  ? and d_id =  ?  ", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
	ECPGt_int,&(d_next_o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 694 "bench_srv.c"


		{ ECPGdo(__LINE__, 0, 1, NULL, "select  max ( o_id )  from orderr where o_w_id =  ? and o_d_id =  ?  ", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
...
#line 699 "bench_srv.c"
		...
		{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from new_order where no_w_id =  ? and no_d_id =  ?  ", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
	ECPGt_int,&(cuenta),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 710 "bench_srv.c"

		if (cuenta!=0){/* There are outstanding orders for this warehouse */
			{ ECPGdo(__LINE__, 0, 1, NULL, "select  max ( no_o_id )  from new_order where no_w_id =  ? and no_d_id =  ?  ", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
...
#line 745 "bench_srv.c"
 int  w_id   ;
 
#line 746 "bench_srv.c"
 int  d_id   ;
 
#line 747 "bench_srv.c"
 int  d_next_o_id   ;
 
#line 748 "bench_srv.c"
 int  o_id   ;
 
#line 749 "bench_srv.c"
 int  cuenta   ;
 
#line 750 "bench_srv.c"
 int  no_o_id   ;
 
#line 751 "bench_srv.c"
 int  max_no_o_id   ;
 
#line 752 "bench_srv.c"
 int  min_no_o_id   ;
/* exec sql end declare section */
#line 753 "bench_srv.c"
...
#line 764 "bench_srv.c"
	...
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
	ECPGt_int,&(max_no_o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 769 "bench_srv.c"

			{ ECPGdo(__LINE__, 0, 1, NULL, "select  min ( no_o_id )  from new_order where no_w_id =  ? and no_d_id =  ?  ", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
	ECPGt_int,&(min_no_o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 773 "bench_srv.c"
...
#line 804 "bench_srv.c"
 int  w_id   ;
 
#line 805 "bench_srv.c"
 int  d_id   ;
 
#line 806 "bench_srv.c"
 int  cuenta1   ;
 
#line 807 "bench_srv.c"
 int  cuenta2   ;
/* exec sql end declare section */
#line 808 "bench_srv.c"
...
for(w_id=1;w_id<=num_alm;w_id++){
	...
	for(d_id=1;d_id<=10;d_id++){
		cuenta1=0;
		cuenta2=0;
		{ ECPGdo(__LINE__, 0, 1, NULL, "select  sum ( o_ol_cnt )  from orderr where o_w_id =  ? and o_d_id =  ?  ", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
	ECPGt_int,&(cuenta1),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 819 "bench_srv.c"


			{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from order_line where ol_w_id =  ? and ol_d_id =  ?  ", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, 
	ECPGt_int,&(cuenta2),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 824 "bench_srv.c"
...
#line 856 "bench_srv.c"
 int  w   ;
/* exec sql end declare section */
#line 857 "bench_srv.c"


/* Conecting to database   */
{ ECPGconnect(__LINE__, 0, "tpcc" , NULL,NULL , NULL, 0); }
#line 860 "bench_srv.c"
/* USER USERNAME;*/
...
#line 900 "bench_srv.c"
 int  w_id   ;
 
#line 901 "bench_srv.c"
 char  w_name [ 11 ]   ;
 
#line 902 "bench_srv.c"
 char  w_street_1 [ 21 ]   ;
 
#line 903 "bench_srv.c"
 char  w_street_2 [ 21 ]   ;
 
#line 904 "bench_srv.c"
 char  w_city [ 21 ]   ;
 
#line 905 "bench_srv.c"
 char  w_state [ 3 ]   ;
 
#line 906 "bench_srv.c"
 char  w_zip [ 10 ]   ;
 
#line 907 "bench_srv.c"
 float  w_tax   ;
 
#line 908 "bench_srv.c"
 double  w_ytd   ;
/* exec sql end declare section */
#line 909 "bench_srv.c"
...
initstate(semilla++, estados[E_W_CITY],32); /*seed (semilla) = 6*/
  ...
  for (i=1; i <= w; i++){
	...
	w_ytd = 300000;
	/* Inserting the row */
	{ ECPGdo(__LINE__, 0, 1, NULL, "insert into warehouse ( w_id  , w_name  , w_street_1  , w_street_2  , w_city  , w_state  , w_zip  , w_tax  , w_ytd  ) values (  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? )", 
	ECPGt_int,&(w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(w_name),(long)11,(long)1,(11)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(w_street_1),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(w_street_2),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(w_city),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(w_state),(long)3,(long)1,(3)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(w_zip),(long)10,(long)1,(10)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_float,&(w_tax),(long)1,(long)1,sizeof(float), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_double,&(w_ytd),(long)1,(long)1,sizeof(double), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 940 "bench_srv.c"
...
#line 989 "bench_srv.c"
 int  d_id   ;
 
#line 990 "bench_srv.c"
 int  d_w_id   ;
 
#line 991 "bench_srv.c"
 char  d_name [ 11 ]   ;
 
#line 992 "bench_srv.c"
 char  d_street_1 [ 21 ]   ;
 
#line 993 "bench_srv.c"
 char  d_street_2 [ 21 ]   ;
 
#line 994 "bench_srv.c"
 char  d_city [ 21 ]   ;
 
#line 995 "bench_srv.c"
 char  d_state [ 3 ]   ;
 
#line 997 "bench_srv.c"
 char  d_zip [ 9 ]   ;
 
#line 998 "bench_srv.c"
 float  d_tax   ;
 
#line 999 "bench_srv.c"
 double  d_ytd   ;
 
#line 1000 "bench_srv.c"
 int  d_next_o_id   ;
/* exec sql end declare section */
#line 1001 "bench_srv.c"
...
initstate(semilla++, estados[E_D_TAX],32); /*seed (semilla) = 11*/
  ...
  for (i = 1; i <= w; i++){ /*for each warehouse */
	...
	/* Inserting the row */
	{ ECPGdo(__LINE__, 0, 1, NULL, "insert into district ( d_id  , d_w_id  , d_name  , d_street_1  , d_street_2  , d_city  , d_state  , d_zip  , d_tax  , d_ytd  , d_next_o_id  ) values (  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? )", 
	ECPGt_int,&(d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(d_name),(long)11,(long)1,(11)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(d_street_1),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(d_street_2),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(d_city),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(d_state),(long)3,(long)1,(3)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(d_zip),(long)9,(long)1,(9)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_float,&(d_tax),(long)1,(long)1,sizeof(float), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_double,&(d_ytd),(long)1,(long)1,sizeof(double), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(d_next_o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1034 "bench_srv.c"
...
#line 1081 "bench_srv.c"
 int  i_id   ;
 
#line 1082 "bench_srv.c"
 int  i_im_id   ;
 
#line 1083 "bench_srv.c"
 char  i_name [ 25 ]   ;
 
#line 1084 "bench_srv.c"
 float  i_price   ;
 
#line 1085 "bench_srv.c"
 char  i_data [ 51 ]   ;
/* exec sql end declare section */
#line 1086 "bench_srv.c"
...
for (i=0;i<NUM_ART;i++){ /* for NUM_ART items*/
	...
	/* Inserting the row */
	{ ECPGdo(__LINE__, 0, 1, NULL, "insert into item ( i_id  , i_im_id  , i_name  , i_price  , i_data  ) values (  ? ,  ? ,  ? ,  ? ,  ? )", 
	ECPGt_int,&(i_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(i_im_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(i_name),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_float,&(i_price),(long)1,(long)1,sizeof(float), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(i_data),(long)51,(long)1,(51)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1127 "bench_srv.c"
...
#line 1194 "bench_srv.c"
 int  s_i_id   ;
 
#line 1195 "bench_srv.c"
 int  s_w_id   ;
 
#line 1196 "bench_srv.c"
 int  s_quantity   ;
 
#line 1197 "bench_srv.c"
 char  s_dist_01 [ 25 ]   ;
 
#line 1198 "bench_srv.c"
 char  s_dist_02 [ 25 ]   ;
 
#line 1199 "bench_srv.c"
 char  s_dist_03 [ 25 ]   ;
 
#line 1200 "bench_srv.c"
 char  s_dist_04 [ 25 ]   ;
 
#line 1201 "bench_srv.c"
 char  s_dist_05 [ 25 ]   ;
 
#line 1202 "bench_srv.c"
 char  s_dist_06 [ 25 ]   ;
 
#line 1203 "bench_srv.c"
 char  s_dist_07 [ 25 ]   ;
 
#line 1204 "bench_srv.c"
 char  s_dist_08 [ 25 ]   ;
 
#line 1205 "bench_srv.c"
 char  s_dist_09 [ 25 ]   ;
 
#line 1206 "bench_srv.c"
 char  s_dist_10 [ 25 ]   ;
 
#line 1207 "bench_srv.c"
 double  s_ytd   ;
 
#line 1208 "bench_srv.c"
 int  s_order_cnt   ;
 
#line 1209 "bench_srv.c"
 int  s_remote_cnt   ;
 
#line 1210 "bench_srv.c"
 char  s_data [ 51 ]   ;
/* exec sql end declare section */
#line 1211 "bench_srv.c"
 ...
 /* initializing state vectors */ 
  ...
  for (i=1; i <= n; i++){ /* for each warehouse */
	...
	/* Inserting the row */
	{ ECPGdo(__LINE__, 0, 1, NULL, "insert into stock ( s_i_id  , s_w_id  , s_quantity  , s_dist_01  , s_dist_02  , s_dist_03  , s_dist_04  , s_dist_05  , s_dist_06  , s_dist_07  , s_dist_08  , s_dist_09  , s_dist_10  , s_ytd  , s_order_cnt  , s_remote_cnt  , s_data  ) values (  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? )", 
	ECPGt_int,&(s_i_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(s_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(s_quantity),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_01),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_02),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_03),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_04),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_05),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_06),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_07),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_08),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_09),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_dist_10),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_double,&(s_ytd),(long)1,(long)1,sizeof(double), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(s_order_cnt),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(s_remote_cnt),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(s_data),(long)51,(long)1,(51)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1270 "bench_srv.c"
...
#line 1328 "bench_srv.c"
 int  c_id   ;
 
#line 1329 "bench_srv.c"
 int  c_d_id   ;
 
#line 1330 "bench_srv.c"
 int  c_w_id   ;
 
#line 1331 "bench_srv.c"
 char  c_first [ 17 ]   ;
 
#line 1332 "bench_srv.c"
 char  c_middle [ 3 ]   ;
 
#line 1333 "bench_srv.c"
 char  c_last [ 17 ]   ;
 
#line 1334 "bench_srv.c"
 char  c_street_1 [ 21 ]   ;
 
#line 1335 "bench_srv.c"
 char  c_street_2 [ 21 ]   ;
 
#line 1336 "bench_srv.c"
 char  c_city [ 21 ]   ;
 
#line 1337 "bench_srv.c"
 char  c_state [ 3 ]   ;
 
#line 1338 "bench_srv.c"
 char  c_zip [ 10 ]   ;
 
#line 1339 "bench_srv.c"
 char  c_phone [ 17 ]   ;
 
#line 1340 "bench_srv.c"
 char  c_since [ 21 ]   ;
 
#line 1341 "bench_srv.c"
 char  c_credit [ 3 ]   ;
 
#line 1342 "bench_srv.c"
 double  c_credit_lim   ;
 
#line 1343 "bench_srv.c"
 float  c_discount   ;
 
#line 1344 "bench_srv.c"
 double  c_balance   ;
 
#line 1345 "bench_srv.c"
 double  c_ytd_payment   ;
 
#line 1346 "bench_srv.c"
 int  c_payment_cnt   ;
 
#line 1347 "bench_srv.c"
 int  c_delivery_cnt   ;
 
#line 1348 "bench_srv.c"
 char  c_data [ 501 ]   ;
/* exec sql end declare section */
#line 1349 "bench_srv.c"
...
/* Initializing state vectors */
  ...
  for (i = 1; i <= w; i++){ /*for each warehouse*/
	...
	for (z = 1; z <= NUM_CLIENT; z++){ 
		...
		/* Inserting the row */
		{ ECPGdo(__LINE__, 0, 1, NULL, "insert into customer ( c_id  , c_d_id  , c_w_id  , c_first  , c_middle  , c_last  , c_street_1  , c_street_2  , c_city  , c_state  , c_zip  , c_phone  , c_since  , c_credit  , c_credit_lim  , c_discount  , c_balance  , c_ytd_payment  , c_payment_cnt  , c_delivery_cnt  , c_data  ) values (  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? )", 
	ECPGt_int,&(c_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c_d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_first),(long)17,(long)1,(17)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_middle),(long)3,(long)1,(3)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_last),(long)17,(long)1,(17)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_street_1),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_street_2),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_city),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_state),(long)3,(long)1,(3)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_zip),(long)10,(long)1,(10)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_phone),(long)17,(long)1,(17)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_since),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_credit),(long)3,(long)1,(3)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_double,&(c_credit_lim),(long)1,(long)1,sizeof(double), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_float,&(c_discount),(long)1,(long)1,sizeof(float), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_double,&(c_balance),(long)1,(long)1,sizeof(double), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_double,&(c_ytd_payment),(long)1,(long)1,sizeof(double), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c_payment_cnt),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(c_delivery_cnt),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(c_data),(long)501,(long)1,(501)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1417 "bench_srv.c"
...
#line 1460 "bench_srv.c"
 int  h_c_id   ;
 
#line 1461 "bench_srv.c"
 int  h_c_d_id   ;
 
#line 1462 "bench_srv.c"
 int  h_c_w_id   ;
 
#line 1463 "bench_srv.c"
 int  h_d_id   ;
 
#line 1464 "bench_srv.c"
 int  h_w_id   ;
 
#line 1465 "bench_srv.c"
 char  h_date [ 21 ]   ;
 
#line 1466 "bench_srv.c"
 double  h_amount   ;
 
#line 1467 "bench_srv.c"
 char  h_data [ 25 ]   ;
/* exec sql end declare section */
#line 1468 "bench_srv.c"
...
/* initializing the vector state */
  ...
  for (i = 1; i <= w; i++){ /*for each warehouse */
	...
	for (z = 1; z <= NUM_CLIENT; z++){ /* for each customer */
		...
		{ ECPGdo(__LINE__, 0, 1, NULL, "insert into history ( h_c_id  , h_c_d_id  , h_c_w_id  , h_d_id  , h_w_id  , h_date  , h_amount  , h_data  ) values (  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? )", 
	ECPGt_int,&(h_c_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(h_c_d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(h_c_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(h_d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(h_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(h_date),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_double,&(h_amount),(long)1,(long)1,sizeof(double), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(h_data),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1493 "bench_srv.c"
...
#line 1544 "bench_srv.c"
 int  o_id   ;
 
#line 1545 "bench_srv.c"
 int  o_d_id   ;
 
#line 1546 "bench_srv.c"
 int  o_w_id   ;
 
#line 1547 "bench_srv.c"
 int  o_c_id   ;
 
#line 1548 "bench_srv.c"
 char  o_entry_d [ 21 ]   ;
 
#line 1549 "bench_srv.c"
 int  o_carrier_id   ;
 
#line 1550 "bench_srv.c"
 int  o_ol_cnt   ;
 
#line 1551 "bench_srv.c"
 int  o_all_local   ;
 
#line 1552 "bench_srv.c"
 int  ol_o_id   ;
 
#line 1553 "bench_srv.c"
 int  ol_d_id   ;
 
#line 1554 "bench_srv.c"
 int  ol_w_id   ;
 
#line 1555 "bench_srv.c"
 int  ol_number   ;
 
#line 1556 "bench_srv.c"
 int  ol_i_id   ;
 
#line 1557 "bench_srv.c"
 int  ol_supply_w_id   ;
 
#line 1558 "bench_srv.c"
 char  ol_delivery_d [ 21 ]   ;
 
#line 1559 "bench_srv.c"
 int  ol_quantity   ;
 
#line 1560 "bench_srv.c"
 float  ol_amount   ;
 
#line 1561 "bench_srv.c"
 char  ol_dist_info [ 25 ]   ;
/* exec sql end declare section */
#line 1562 "bench_srv.c"
  ...
  for (i = 1; i <= w; i++){ /*for each warehouse*/
	...
	for (z = 1; z <= NUM_ORDER; z++){ /* NUM_ORDER orders */
		...
		{	setstate(estados[E_O_CARRIER_ID]);
			...
			{ ECPGdo(__LINE__, 0, 1, NULL, "insert into orderr ( o_id  , o_d_id  , o_w_id  , o_c_id  , o_entry_d  , o_carrier_id  , o_ol_cnt  , o_all_local  ) values (  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? )", 
	ECPGt_int,&(o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(o_d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(o_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(o_c_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(o_entry_d),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(o_carrier_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(o_ol_cnt),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(o_all_local),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1593 "bench_srv.c"

			{ ECPGtrans(__LINE__, NULL, "commit");}
#line 1594 "bench_srv.c"
		...
		{	/* inserting 0 in o_carrier_id*/
			{ ECPGdo(__LINE__, 0, 1, NULL, "insert into orderr ( o_id  , o_d_id  , o_w_id  , o_c_id  , o_entry_d  , o_carrier_id  , o_ol_cnt  , o_all_local  ) values (  ? ,  ? ,  ? ,  ? ,  ? , 0 ,  ? ,  ? )", 
	ECPGt_int,&(o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(o_d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	...
	ECPGt_int,&(o_all_local),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1606 "bench_srv.c"

			{ ECPGtrans(__LINE__, NULL, "commit");}
#line 1607 "bench_srv.c"
		...
		for (q=1;q<=o_ol_cnt;q++){
			...
			if (z<N_OR_UNDELIVER){	
				ol_amount=0;
				{ ECPGdo(__LINE__, 0, 1, NULL, "insert into order_line ( ol_o_id  , ol_d_id  , ol_w_id  , ol_number  , ol_i_id  , ol_supply_w_id  , ol_delivery_d  , ol_quantity  , ol_amount  , ol_dist_info  ) values (  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? )", 
	ECPGt_int,&(ol_o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(ol_d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(ol_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(ol_number),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(ol_i_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(ol_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(o_entry_d),(long)21,(long)1,(21)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(ol_quantity),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_float,&(ol_amount),(long)1,(long)1,sizeof(float), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(ol_dist_info),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1636 "bench_srv.c"

				{ ECPGtrans(__LINE__, NULL, "commit");}
#line 1637 "bench_srv.c"
				...
				{ ECPGdo(__LINE__, 0, 1, NULL, "insert into order_line ( ol_o_id  , ol_d_id  , ol_w_id  , ol_number  , ol_i_id  , ol_supply_w_id  , ol_quantity  , ol_amount  , ol_dist_info  ) values (  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? ,  ? )", 
	ECPGt_int,&(ol_o_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_int,&(ol_d_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	...
	ECPGt_char,(ol_dist_info),(long)25,(long)1,(25)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1652 "bench_srv.c"

				{ ECPGtrans(__LINE__, NULL, "commit");}
#line 1653 "bench_srv.c"
...
#line 1686 "bench_srv.c"
 int  no_o_id   ;
 
#line 1687 "bench_srv.c"
 int  no_d_id   ;
 
#line 1688 "bench_srv.c"
 int  no_w_id   ;
/* exec sql end declare section */
#line 1689 "bench_srv.c"
  ...
  for (i = 1; i <= w; i++){ /*for each warehouse*/
	...
	ECPGt_int,&(no_w_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 1701 "bench_srv.c"

		{ ECPGtrans(__LINE__, NULL, "commit");}
#line 1702 "bench_srv.c"
...
\* ----------------------------------------------- */
   ...
   /*********************WAREHOUSE TABLE**********************/
   { ECPGdo(__LINE__, 0, 1, NULL, "create  table warehouse ( w_id int4   , w_name varchar ( 10 )    , w_street_1 varchar ( 20 )    , w_street_2 varchar ( 20 )    , w_city varchar ( 20 )    , w_state char  ( 2 )    , w_zip char  ( 9 )    , w_tax float4   , w_ytd float8   , constraint wareh1 primary key( w_id )  )    ", ECPGt_EOIT, ECPGt_EORT);}
#line 1738 "bench_srv.c"
   ...
   /*************************ITEM TABLE************************/
   { ECPGdo(__LINE__, 0, 1, NULL, "create  table item ( i_id int4   , i_im_id int4   , i_name varchar ( 24 )    , i_price float8   , i_data varchar ( 50 )    , constraint item1 primary key( i_id )  )    ", ECPGt_EOIT, ECPGt_EORT);}
#line 1755 "bench_srv.c"
...
#line 1764 "bench_srv.c"
   ...
   /*********************STOCK TABLE**************************/
   { ECPGdo(__LINE__, 0, 1, NULL, "create  table stock ( s_i_id int4   , s_w_id int4   , s_quantity int2   , s_dist_01 char  ( 24 )    , s_dist_02 char  ( 24 )    , s_dist_03 char  ( 24 )    , s_dist_04 char  ( 24 )    , s_dist_05 char  ( 24 )    , s_dist_06 char  ( 24 )    , s_dist_07 char  ( 24 )    , s_dist_08 char  ( 24 )    , s_dist_09 char  ( 24 )    , s_dist_10 char  ( 24 )    , s_ytd numeric ( 8 , 2 )   , s_order_cnt int2   , s_remote_cnt int2   , s_data varchar ( 50 )    , constraint stock1 primary key( s_w_id , s_i_id )  , constraint stock2 foreign key( s_w_id ) references warehouse ( w_id )   deferrable , constraint stock3 foreign key( s_i_id ) references item ( i_id )   deferrable )    ", ECPGt_EOIT, ECPGt_EORT);}
#line 1795 "bench_srv.c"
...
#line 1803 "bench_srv.c"
   ...
   /************************DISTRICT TABLE*********************/
   { ECPGdo(__LINE__, 0, 1, NULL, "create  table district ( d_id int4   , d_w_id int4   , d_name varchar ( 10 )    , d_street_1 varchar ( 20 )    , d_street_2 varchar ( 20 )    , d_city varchar ( 20 )    , d_state char  ( 2 )    , d_zip char  ( 9 )    , d_tax float4   , d_ytd float8   , d_next_o_id int4   , constraint dist1 primary key( d_w_id , d_id )  , constraint dist2 foreign key( d_w_id ) references warehouse ( w_id )   deferrable )    ", ECPGt_EOIT, ECPGt_EORT);}
#line 1828 "bench_srv.c"
...
#line 1836 "bench_srv.c"
   ...
   /**************CUSTOMER TABLE********/
   { ECPGdo(__LINE__, 0, 1, NULL, "create  table customer ( c_id int4   , c_d_id int4   , c_w_id int4   , c_first varchar ( 16 )    , c_middle char  ( 2 )    , c_last varchar ( 16 )    , c_street_1 varchar ( 20 )    , c_street_2 varchar ( 20 )    , c_city varchar ( 20 )    , c_state char  ( 2 )    , c_zip char  ( 9 )    , c_phone char  ( 16 )    , c_since timestamp    default '1970-01-01' , c_credit char  ( 2 )    , c_credit_lim float8   , c_discount float4   , c_balance float8   , c_ytd_payment float8   , c_payment_cnt int2   , c_delivery_cnt int2   , c_data varchar ( 500 )    , constraint custom1 primary key( c_w_id , c_d_id , c_id )  , constraint custom2 foreign key( c_w_id , c_d_id ) references district ( d_w_id , d_id )   deferrable )    ", ECPGt_EOIT, ECPGt_EORT);}
#line 1870 "bench_srv.c"
...
#line 1878 "bench_srv.c"
   ...
   /**************HISTORY TABLE********/
   { ECPGdo(__LINE__, 0, 1, NULL, "create  table history ( h_c_id int4   , h_c_d_id int4   , h_c_w_id int4   , h_d_id int4   , h_w_id int4   , h_date timestamp    default '1970-01-01' , h_amount float4   , h_data varchar ( 24 )    , constraint hist1 foreign key( h_c_w_id , h_c_d_id , h_c_id ) references customer ( c_w_id , c_d_id , c_id )   deferrable , constraint hist2 foreign key( h_w_id , h_d_id ) references district ( d_w_id , d_id )   deferrable )    ", ECPGt_EOIT, ECPGt_EORT);}
#line 1900 "bench_srv.c"
...
#line 1910 "bench_srv.c"
  ...
  /***********************ORDERR TABLE*******************/
  { ECPGdo(__LINE__, 0, 1, NULL, "create  table orderr ( o_id int4   , o_w_id int4   , o_d_id int4   , o_c_id int4   , o_entry_d timestamp    default '1970-01-01' , o_carrier_id int2   default 0 , o_ol_cnt int2   , o_all_local int2   , constraint orderr1 primary key( o_w_id , o_d_id , o_id )  , constraint orderr2 foreign key( o_w_id , o_d_id , o_c_id ) references customer ( c_w_id , c_d_id , c_id )   deferrable )    ", ECPGt_EOIT, ECPGt_EORT);}
#line 1932 "bench_srv.c"
...
#line 1940 "bench_srv.c"
  ...
  /****************ORDER_LINE TABLE********************/
  { ECPGdo(__LINE__, 0, 1, NULL, "create  table order_line ( ol_o_id int4   , ol_d_id int4   , ol_w_id int4   , ol_number int2   , ol_i_id int4   , ol_supply_w_id int4   , ol_delivery_d timestamp    default '1970-01-01' , ol_quantity int2   , ol_amount numeric ( 6 , 2 )   , ol_dist_info char  ( 24 )    , constraint ol1 primary key( ol_w_id , ol_d_id , ol_o_id , ol_number )  , constraint ol2 foreign key( ol_w_id , ol_d_id , ol_o_id ) references orderr ( o_w_id , o_d_id , o_id )   deferrable , constraint ol3 foreign key( ol_supply_w_id , ol_i_id ) references stock ( s_w_id , s_i_id )   deferrable )    ", ECPGt_EOIT, ECPGt_EORT);}
#line 1963 "bench_srv.c"
 /* exec*/
   /**************ERROR HANDLING********/
   if (sqlca.sqlcode<0){
	fprintf(stderr, "ERROR CREATING TABLE DISTRICT\n");
...
#line 1971 "bench_srv.c"
  ...
  /******************NEW_ORDER TABLE*******************/
  { ECPGdo(__LINE__, 0, 1, NULL, "create  table new_order ( no_o_id int4   , no_d_id int4   , no_w_id int4   , constraint no1 primary key( no_w_id , no_d_id , no_o_id )  , constraint no2 foreign key( no_w_id , no_d_id , no_o_id ) references orderr ( o_w_id , o_d_id , o_id )   deferrable )    ", ECPGt_EOIT, ECPGt_EORT);}
#line 1987 "bench_srv.c"
...
{ ECPGconnect(__LINE__, 0, "template1" , NULL,NULL , NULL, 0); }
#line 2030 "bench_srv.c"
/* USER USERNAME;*/
if (sqlca.sqlcode<0){
...
{ ECPGsetcommit(__LINE__, "on", NULL);}
#line 2038 "bench_srv.c"
 

/************** CREATING THE DATABASE *********/
{ ECPGdo(__LINE__, 0, 1, NULL, "create database tpcc", ECPGt_EOIT, ECPGt_EORT);}
#line 2041 "bench_srv.c"
...
{ ECPGdisconnect(__LINE__, "CURRENT");}
#line 2050 "bench_srv.c"


/************* CONNECTING to tpcc ***************/
{ ECPGconnect(__LINE__, 0, "tpcc" , NULL,NULL , NULL, 0); }
#line 2053 "bench_srv.c"
/* USER USERNAME;*/
...
#line 3924 "bench_srv.c"
 int  ll   ;
 
#line 3925 "bench_srv.c"
 int  ls   ;
/* exec sql end declare section */
#line 3926 "bench_srv.c"


/* Connecting with database */
{ ECPGconnect(__LINE__, 0, "tpcc" , NULL,NULL , NULL, 0); }
#line 3929 "bench_srv.c"
/* USER USERNAME;*/

/* Checking warehouse table */
fprintf(stdout, "\tWarehouse table... ");
fflush(stdout);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count ( w_id )  from warehouse   ", ECPGt_EOIT, 
	ECPGt_int,&(ll),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 3934 "bench_srv.c"
...
fflush(stdout);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count ( s_quantity )  from stock   ", ECPGt_EOIT, 
	ECPGt_int,&(ll),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 3957 "bench_srv.c"
...
fflush(stdout);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count ( i_id )  from item   ", ECPGt_EOIT, 
	ECPGt_int,&(ll),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 3974 "bench_srv.c"
...
fflush(stdout);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count ( d_ytd )  from district   ", ECPGt_EOIT, 
	ECPGt_int,&(ll),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 3991 "bench_srv.c"
...
fflush(stdout);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count ( c_id )  from customer   ", ECPGt_EOIT, 
	ECPGt_int,&(ll),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4008 "bench_srv.c"
...
fflush(stdout);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count ( h_amount )  from history   ", ECPGt_EOIT, 
	ECPGt_int,&(ll),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4025 "bench_srv.c"
...
fflush(stdout);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count ( o_id )  from orderr   ", ECPGt_EOIT, 
	ECPGt_int,&(ll),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4042 "bench_srv.c"
...
fflush(stdout);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  SUM ( o_ol_cnt )  from orderr   ", ECPGt_EOIT, 
	ECPGt_int,&(ls),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4059 "bench_srv.c"
...
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count ( ol_quantity )  from order_line   ", ECPGt_EOIT, 
	ECPGt_int,&(ll),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4067 "bench_srv.c"
...
if (caso == CASO_TEST) {
	...
	fflush(stdout);
	{ ECPGdo(__LINE__, 0, 1, NULL, "select  count ( no_o_id )  from new_order   ", ECPGt_EOIT, 
	ECPGt_int,&(ll),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4085 "bench_srv.c"
...
#line 4114 "bench_srv.c"
 int  n_fil   ;
/* exec sql end declare section */
#line 4115 "bench_srv.c"


/* Connecting with tpcc */
{ ECPGconnect(__LINE__, 0, "tpcc" , NULL,NULL , NULL, 0); }
#line 4118 "bench_srv.c"
/* USER USERNAME;*/

fprintf(stdout,"\n\n\n\n\n\n\n		CARDINALITY OF TABLES:\n\n\n");
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from warehouse   ", ECPGt_EOIT, 
	ECPGt_int,&(n_fil),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4121 "bench_srv.c"

if(n_fil==1)
fprintf(stdout,"		->WAREHOUSE table: %d row.\n",n_fil);
else
fprintf(stdout,"		->WAREHOUSE table: %d rows.\n",n_fil);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from district   ", ECPGt_EOIT, 
	ECPGt_int,&(n_fil),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4126 "bench_srv.c"

fprintf(stdout,"		->DISTRICT table: %d rows.\n",n_fil);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from item   ", ECPGt_EOIT, 
	ECPGt_int,&(n_fil),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4128 "bench_srv.c"

fprintf(stdout,"		->ITEM table: %d rows.\n",n_fil);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from stock   ", ECPGt_EOIT, 
	ECPGt_int,&(n_fil),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4130 "bench_srv.c"

fprintf(stdout,"		->STOCK table: %d rows.\n",n_fil);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from customer   ", ECPGt_EOIT, 
	ECPGt_int,&(n_fil),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4132 "bench_srv.c"

fprintf(stdout,"		->CUSTOMER table: %d rows.\n",n_fil);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from history   ", ECPGt_EOIT, 
	ECPGt_int,&(n_fil),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4134 "bench_srv.c"

fprintf(stdout,"		->HISTORY table: %d rows.\n",n_fil);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from orderr   ", ECPGt_EOIT, 
	ECPGt_int,&(n_fil),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4136 "bench_srv.c"

fprintf(stdout,"		->ORDER table: %d rows.\n",n_fil);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from order_line   ", ECPGt_EOIT, 
	ECPGt_int,&(n_fil),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4138 "bench_srv.c"

fprintf(stdout,"		->ORDER-LINE table: %d rows.\n",n_fil);
{ ECPGdo(__LINE__, 0, 1, NULL, "select  count (*)  from new_order   ", ECPGt_EOIT, 
	ECPGt_int,&(n_fil),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 4140 "bench_srv.c"

fprintf(stdout,"		->NEW-ORDER table: %d rows.\n",n_fil);

{ ECPGdisconnect(__LINE__, "CURRENT");}
#line 4143 "bench_srv.c"
...
strcat(filenameBuffer,"medida.log");
			...
			fprintf(stdout,"Finished.\n");
                ...
                case 5: /*delete database*/
                        ...
                        { ECPGconnect(__LINE__, 0, "template1" , NULL,NULL , NULL, 0); }
#line 4529 "bench_srv.c"
/* USER USERNAME;*/
                        { ECPGsetcommit(__LINE__, "on", NULL);}
#line 4530 "bench_srv.c"


                        /* Delete database */
                        { ECPGdo(__LINE__, 0, 1, NULL, "drop database tpcc", ECPGt_EOIT, ECPGt_EORT);}
#line 4533 "bench_srv.c"
...
/* USER USERNAME;*/
        		...
        		{ ECPGsetcommit(__LINE__, "on", NULL);}
#line 4584 "bench_srv.c"


			/* Trying to create database tpcc */
        		{ ECPGdo(__LINE__, 0, 1, NULL, "create database tpcc", ECPGt_EOIT, ECPGt_EORT);}
#line 4587 "bench_srv.c"
